...
- **正式網域**: [https://juno21.com](https://juno21.com)
- **後台管理介面**: [https://juno21.com/admin](https://juno21.com/admin)

如果您需要更新 DNS 紀錄或網域設定，請確保在您的網域註冊商 (例如 GoDaddy, Cloudflare 等) 以及 Vercel 專案設定中完成正確的 CNAME 或 A 紀錄指向。

## 版權與授權聲明 (Copyright & License)

© 2026 JuNo.21. All rights reserved. 

本網站之所有內容、文章、圖片、程式碼及設計架構均受著作權法保護，未經書面授權，禁止以任何形式複製、轉載、修改或商業使用。
如果您需要在其他商業環境中使用本專案之開源部分，請與專案擁有者聯繫取得授權。
